...
const CallOptions = () => {
  ...
  return <>
    <div className="absolute bottom-0 left-0">
      <IconButton onClick={toggleUserAudio} size="large">{enableUserAudio ? <Mic /> : <MicOff />}</IconButton>
      <IconButton onClick={toggleUserVideo} size="large">{enableUserVideo ? <Videocam /> : <VideocamOff />}</IconButton>
