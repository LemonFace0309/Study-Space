...
export default function Timer() {
  ...
  return (
    <Paper elevate={10} className="rounded-3xl">
      <Box bgcolor={theme.palette.primary.light} className="flex flex-col justify-center p-5 rounded-3xl">
        <Grid className="grid grid-cols-1">
          <Box color={theme.palette.primary.info} bgcolor={theme.palette.primary.medium} className="rounded-lg">
          ...
          <Container className="flex flex-col text-center justify-between ">
            <Box color={theme.palette.primary.dark} className="text-6xl uppercase tracking-widest font-semibold">
