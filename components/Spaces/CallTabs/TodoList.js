...
import { Button, IconButton, Divider, TextField, Collapse, List, ListItem, ListItemText } from '@mui/material';
    ...
    <List className="h-full flex flex-col justify-between p-1">
      ...
      <div>
        ...
        <ListItem className="p-1">
          ...
          <IconButton onClick={handleClick} size="large">{open ? <ExpandLess /> : <ExpandMore />}</IconButton>
        </ListItem>
