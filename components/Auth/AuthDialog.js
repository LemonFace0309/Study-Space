            ...
            <div className="flex-grow flex flex-col items-center p-8">
              ...
              <div className="flex w-full justify-center items-center">
                <IconButton
                  ...
                  onClick={() => signIn(providers?.facebook.id, { callbackUrl: `${process.env.NEXT_PUBLIC_URL}` })}>
                  <Image src="/images/facebook.svg" alt="Facebook Login" height="32" width="32" />
                </IconButton>
                <IconButton
                  className="outline-none"
                  onClick={() => signIn(providers?.google.id, { callbackUrl: `${process.env.NEXT_PUBLIC_URL}` })}>
